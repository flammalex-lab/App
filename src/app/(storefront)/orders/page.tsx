...
function EmptyState({
  ...
  // CTA when no zone is set. Icon is informational (neutral) rather than
  // success-tinted — green is reserved for the commit moment.
  return (
    <div className="card p-6 text-center">
      <div className="mx-auto h-14 w-14 rounded-full bg-bg-secondary text-ink-secondary inline-flex items-center justify-center mb-4">
