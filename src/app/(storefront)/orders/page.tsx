    ...
    <div className="card p-6 text-center">
      <div className="mx-auto mb-5 w-full max-w-sm md:max-w-md">
        <div className="relative aspect-[16/9] overflow-hidden rounded-xl shadow-[0_1px_2px_rgba(22,22,22,0.04)] ring-1 ring-black/[0.04]">
          <Image
            src="/photos/farm-3.jpg"
            alt="A barn at one of our partner farms in the Finger Lakes"
            fill
      ...
      <p className="display text-[22px] tracking-tight text-ink-primary mb-1">
        Nothing on the truck yet.
      </p>
      {nextDelivery ? (
        <p className="text-[13px] text-ink-secondary mb-5">
          Next delivery <strong className="text-ink-primary">{dateShort(nextDelivery.deliveryDate)}</strong>
          {" — "}order by{" "}
