 ...
 * URL commit so the buyer sees the sheet slide up with a placeholder
 * instead of nothing.
 *
...
export default function ProductModalLoading() {
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center md:justify-center bg-black/55 animate-fade-in pointer-events-none">
      <div
        className="relative w-full bg-white rounded-t-2xl md:rounded-2xl shadow-floating animate-sheet-up md:animate-slide-up h-[75vh] md:h-auto md:max-h-[92vh] flex flex-col animate-pulse"
