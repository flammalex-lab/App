 ...
 *   1. Active B2B-visible products with no wholesale_price (resolvePrice
 *      returns null → order rejected).
...
export default async function HealthPage() {
  ...
  const [unpricedRes, noZoneRes] = await Promise.all([
    db
      .from("products")
      .select("id, name, sku, brand, category, available_b2b, available_dtc")
