...
values
  ...
  ('BF-FLK-001','grasslands','meat','Flank Steak','Trimmed, 2 lb avg',                             'Plate', 'Flank','retail_cut','lb','2 lb avg', null, 2.0, 11.50, 20.00, true, true, 170),
  ('BF-HNG-001','grasslands','meat','Hanger Steak','Butcher''s steak, 1.5 lb avg',                 null, null,'retail_cut','lb','1.5 lb avg', null, 1.5, 13.00, 22.00, true, true, 180),
  ('BF-OXT-001','grasslands','meat','Oxtail','Cross-cut, 2 lb pack',                               'Tail', null,'retail_cut','lb','2 lb pack', null, 2.0, 8.00, 14.00, true, true, 190),

  -- PORK (expanded)
  ('PK-HAM-001','fingerlakes_farms','meat','Smoked Ham Steak','Center cut, 1 lb',                  null, null,'retail_cut','lb','1 lb', null, 1.0, 6.50, 12.00, true, true, 260),
  ('PK-BAC-001','fingerlakes_farms','meat','Thick-Cut Bacon — 1 lb','Dry-cured, hickory smoked',   null, null,'value_added','lb','1 lb pack', null, 1.0, 9.50, 16.00, true, true, 270),

  -- LAMB
  ('LB-GRD-001','fingerlakes_farms','meat','Ground Lamb','85/15 grind, 1 lb pack',                 null, null,'retail_cut','lb','1 lb pack', null, 1.0, 10.50, 18.00, true, true, 610),
  ('LB-RCK-001','fingerlakes_farms','meat','Lamb Rack — Frenched','8-bone, 2 lb avg',              'Rib', null,'sub_primal','lb','2 lb avg', null, 2.0, 22.00, 38.00, true, true, 620),
  ('LB-SHK-001','fingerlakes_farms','meat','Lamb Shank','Braising, 1 lb avg',                      'Shank', null,'retail_cut','lb','1 lb avg', null, 1.0, 9.00, 15.00, true, true, 630),
